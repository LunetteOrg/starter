...
| [0004](./0004-scaffolding-contract.md) | The scaffolding contract | accepted (marker clause superseded by 0008) |
...
| [0008](./0008-drop-the-template-marker.md) | Drop the `.lunette-template` marker (state the rule instead) | accepted |
